...
static int init_filters(AppContext *ctx, const char *filter_description)
{
    ...
    snprintf(args, sizeof(args),
             ...
             ctx->dec_ctx->width, ctx->dec_ctx->height,
             AV_PIX_FMT_VPE,  /* Hardware pixel format */
    ...
    /* Set hardware frames context - critical for hwdownload_ama */
    ...
    if (strcmp(ctx->output_format, "yuv420p") == 0)
        out_fmt = AV_PIX_FMT_YUV420P;
    else
        out_fmt = AV_PIX_FMT_NV12;
...
int main(int argc, char **argv)
{
    ...
    /* Use hwdownload_ama to transfer from VPE hardware to software format */
    if ((ret = init_filters(&ctx, "hwdownload_ama")) < 0) {
