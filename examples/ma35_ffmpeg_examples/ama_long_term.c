...
static int init_filters(AppContext *ctx)
{
    ...
    /* Create unconstrained buffer sink; output stays VPE for HW-to-HW scaling.
     * pix_fmts option is deprecated -- scaler_ama output format is set via
     * the filter chain, not the sink. */
